...
const studenttyldataSchema = new mongoose.Schema({
  ...
  usn: String,
  phno: String,
  coreCx: { c1: String, c2: String, c3: String, c4: String, c5: String, c6: String, c7: String, c8: String },
  coreProgramming: { cp1: String, cp2: String, cp3: String, cp4: String, cp5: String, cp6: String, cp7: String },
